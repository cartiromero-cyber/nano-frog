export default function RoofHealthScore() {
  ...
  <div class="wrap" style="position:relative;z-index:2">
    <div class="shead center reveal">
      <span class="eyebrow lt" style="justify-content:center">Roof Health Score™</span>
    ...
    <div class="reveal" style="max-width:760px;margin:46px auto 0">
      <div class="scorecard">
        <div class="sc-top"><span class="sc-brand">Roof Health Score™</span><span class="sc-tag">Example only</span></div>
        <div class="gauge-wrap">
          ...
          <div>
            ...
            <div class="sc-note">Example only — official score requires inspection. Scoring methodology <span class="flag">[VERIFY WITH CLIENT]</span></div>
          </div>
        </div>
      ...
      <p class="center muted" style="text-align:center;margin-top:22px;font-size:.86rem">Every assessment produces a score and a documented Roof Life Report™ — whether the recommendation is to preserve or to replace.</p>
    </div>
  </div>
` }}
    />
