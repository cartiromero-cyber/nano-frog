...
// Shared printable Roof Health Report card — used by the report slide AND the finale
// (so print/save works from either). Extracted verbatim from StepReport.
...
export default function ReportCard({ session }: { session: SalesSession }) {
