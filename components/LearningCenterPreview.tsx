export default function LearningCenterPreview() {
 ...
 <a class="lcard reveal" href="#"><div class="k">Technology</div><h3>Nano vs. oil vs. coatings</h3><p>How nanotechnology preservation differs — and what to ask any provider.</p><span class="go">Read &rarr;</span></a>
