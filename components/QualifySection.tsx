export default function QualifySection() {
  ...
  <div class="wrap qsplit">
    <div class="reveal">
      ...
      <ul class="qcheck">
        <li><span class="yes"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg></span><div><b>Good candidate:</b> an aging but structurally sound roof with life left to protect. <span class="flag">[VERIFY candidacy standards]</span></div></li>
